...
const copy = computed(() => {
    const map = {
        pt_BR: {
            ...
            description: 'Conheca a WMST: software sob medida, automações com IA e produtos proprios para PMEs que precisam crescer sem ampliar equipe.',
            eyebrow: 'Sobre nos',
            heading: 'Engenharia de software com',
            highlight: 'obsessao por resultados',
            mission: 'Missao',
            vision: 'Visao',
            ...
            metricsHighlight: 'falam por nos',
            ctaTitle: 'Vamos transformar seu negócio?',
            ctaDescription: 'Fale com nosso time e receba um diagnostico gratuito em ate 24h.',
            ...
            <div class="mx-auto max-w-6xl px-4 md:px-8">
                ...
                <div class="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <Reveal v-for="(v, i) in company.values" :key="v.title" :delay="i * 80">
                        <article class="flex h-full flex-col rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-[color:var(--color-brand)]/40 hover:shadow-xl">
            ...
            <div class="relative mx-auto max-w-4xl px-4 text-center text-white md:px-8">
                <Reveal>
                    ...
                    <div class="mt-8 flex flex-wrap justify-center gap-3">
                        <a :href="company.contact.whatsapp" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-semibold text-zinc-900 shadow-lg transition hover:-translate-y-0.5">
