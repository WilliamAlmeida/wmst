    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            @foreach($testimonials as $value)
                <div class="opacity-0 delay-500 duration-1000" x-data="{shown:false}" x-intersect="shown=true" :class="{'fade-in-up':shown}">
                    <div class="flex flex-col gap-6 rounded-xl border py-6 shadow-sm bg-gradient-card border-neutral-content hover:border-primary/30 transition-all duration-300">
